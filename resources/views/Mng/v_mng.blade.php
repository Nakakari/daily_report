...
@section('js')
    <script type="text/javascript">
            ...
            "columnDefs": [{
                ...
                "render": function(data, type, row, meta) {
                    return `<p><b>Customer: </b>` + row.nama_cust + `<br>` +
                        ...
                        `<a class="btn btn-sm btn-info" href="detail_report4/${row.id_report}">Detail</a>`;
                }
            }, {
                "targets": 3,
                "data": "by_mng",
        ...
        function toggleRevision(id_report) {
            ...
            if (_c === true) {
                let report = list_report[id_report]
                const by_mng_update = 2;
                $.ajax({
                    url: '{{ url('') }}/by_mng/revision',
                    method: 'POST',
                    data: {
                        id_report: id_report,
